...
function buildList() {
    ...
    var url = "http://rmiaouh.site/api/task-list/"
    fetch(url)
        .then((resp) => resp.json())
        .then(function (data) {
...
form.addEventListener('submit', function (e) {
    ...
    var url = "http://rmiaouh.site/api/task-babel/"

    if (activeItem != null){
        var url = `http://rmiaouh.site/api/task-update/${activeItem.id}/`
        activeItem = null
    }
...
function deleteItem(item) {
    ...
    fetch(`http://rmiaouh.site/api/task-delete/${item.id}/`, {
        method:'DELETE',
        headers: {
            'Content-type': 'application/json',
            'X-CSRFToken': csrftoken,
...
function strikeUnstrike(item){
    ...
    fetch(`http://rmiaouh.site/api/task-update/${item.id}/`, {
        method:'POST',
        headers: {
            'Content-type': 'application/json',
            'X-CSRFToken': csrftoken,
